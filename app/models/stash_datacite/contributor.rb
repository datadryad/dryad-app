...
module StashDatacite
  class Contributor < ApplicationRecord
    ...
    validates_length_of :award_number, maximum: 191, allow_blank: true, message: 'Award number is too long'
    validates_length_of :award_title, maximum: 191, allow_blank: true, message: 'Award title is too long'
    validates_length_of :award_description, maximum: 191, allow_blank: true, message: 'Program/division is too long'
