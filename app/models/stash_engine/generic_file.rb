...
#  index_stash_engine_generic_files_on_type_and_digest    (type,digest)
...
module StashEngine
  class GenericFile < ApplicationRecord
    ...
    scope :generated, -> { where(download_filename: ['README.md', 'DisciplineSpecificMetadata.json'], type: StashEngine::DataFile) }
