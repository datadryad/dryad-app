        ...
        <div className={classes.ModalUrl}>
            <section className={classes.ModalUrlMain}>
                ...
                <form onSubmit={props.submitted}>
                    <textarea name="file_urls" rows="15" cols="100" onChange={props.changedUrls} />
                    <br/><br/><br/>
                    {/*<input type="submit" value="Validate files" />*/}
                    <input
                        type="checkbox" id="confirm_not_personal_health_url" className={classes.ConfirmPersonalHealth}
                    />
                    ...
                    <div>
                        <input className={classes.ValidateUrls} type="submit" value="Validate files" />
