...
const nondescript = (t) => {
  ...
  const remainder = t.replace(/[^a-z0-9\s]/gi, '').replace(/(raw|data|dataset|dryad|fig|figure|figures|table|tables|file|supp|suppl|supplement|supplemental|extended|supplementary|supporting|et al|the|of|for|in|from|to|s\d|f\d|t\d)\s/gi, '').trim();
