...
const instructions = () => (
  <div>
    ...
    <p>
      We require that you include a <a href="/docs/README.md" target="_blank">README.md</a> file based on our template in
      order to provide key
      information for understanding and reuse of your data.
    </p>
    <p>If you prefer, you can edit the Markdown online
      at <a href="https://hackmd.io/JgxUwkEdS9uOOcgadhe29w?both=" target="_blank">hackmd.io</a>.
    </p>
