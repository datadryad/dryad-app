module FilesHelper
  ...
  def download_file_name_link(file, params)
    file_name = file.upload_file_name.ellipsisize(200)
    ...
    link_to download_stream_path(params), title: file.upload_file_name, target: '_blank', class: 'js-individual-dl' do
