...
Waivers are granted for submissions originating from researchers based in countries classified by the <a href="https://datahelpdesk.worldbank.org/knowledgebase/articles/906519-world-bank-country-and-lending-groups">World Bank</a> as low-income or lower-middle-income economies. We are sensitive to the fact that fees for individual researchers can be a burden and create inequities. If you would like to request a fee waiver, please contact <a href="mailto:help@datadryad.org">help@datadryad.org</a>.
