...
<p>
    All data submissions are assigned a private, randomized URL. This link can be shared with the journal office
    and/or with collaborators to access the data files before the dataset is made public. When your dataset is published, 
    this temporary URL will be deactivated and the DOI assigned to your dataset upon submission will become its public URL.
</p>    
