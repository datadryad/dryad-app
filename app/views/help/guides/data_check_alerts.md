...
When you upload files to Dryad, our [tabular data checker](/help/submission_steps/files#tabular-data-check) will analyze many of your data files, generating reports for any inconsistencies found. Correcting inconsistencies increases the accessibility of the data.
