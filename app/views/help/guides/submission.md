<% @page_title = 'Submitting data' %>
<h1>Submitting data</h1>

Before you begin a submission, please ensure your submission meets [our requirements](/help/requirements/files) and follows [good data practices](/best_practices). 
...
<ol id="infographic">
  <li>
    <h3><i class="fas fa-arrow-up-from-bracket" aria-hidden="true"></i>Initial submission</h3>
    <p>Upload your data, complete metadata fields, and prepare a README file. Complete the checklist and carefully review the dataset before you pay and submit.</p>
  </li>
  <li>
    <h3><i class="fas fa-eye-slash" aria-hidden="true"></i>Private for Peer Review option</h3>
  ...
  <li>
    <h3><i class="fas fa-layer-group" aria-hidden="true"></i>Curation</h3>
  ...
  <li>
    <h3><i class="fas fa-arrow-rotate-left" aria-hidden="true"></i>Revisions</h3>
    <p>Revise your dataset based on curator feedback.<br />Don&apos;t hesitate to contact us with questions!</p>
  </li>
  <li>
    <h3><i class="fas fa-database" aria-hidden="true"></i>Publication</h3>
