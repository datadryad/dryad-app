Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'dryad-migration.cdlib.org' }
  Rails.application.default_url_options = { host: 'dryad-migration.cdlib.org', protocol: 'https' }
