Rails.application.routes.draw do
  ...
  scope module: 'stash_engine' do
    ...
    post 'generic_file/trigger_sd_scan/:resource_id', to: 'generic_files#trigger_sd_scan', as: 'trigger_sd_scan'
    post 'generic_file/trigger_frictionless/:resource_id',to: 'generic_files#trigger_frictionless', as: 'trigger_frictionless'
