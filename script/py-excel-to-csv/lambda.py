...
class ExcelToCsv:
  ...
  # set processor message as started
  ...
  def update_processor_end(self):
    self.update_processor('success', f'ended processing lambda at {datetime.now().isoformat()}', '')
  ...
  # attempt downloading the Excel file as 'excelfile.{ext}'
