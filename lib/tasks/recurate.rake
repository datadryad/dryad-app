...
namespace :recurate do
  ...
  # example usage: RAILS_ENV=development bundle exec rake recurate:nsf_contributors
  desc 'Re-curate contributors that have NIH as direct funder'
  ...
  desc 'Re-curate resources that are assigned to Sri Lanka ROR'
  ...
  desc 'Re-curate resources that are assigned to Pakistan ROR'
