...
bundle exec rails affiliation_import:update_affiliations_name >> /home/ec2-user/deploy/shared/log/affiliations_name_updates.log 2>&1
bundle exec rails affiliation_import:update_contributors_name >> /home/ec2-user/deploy/shared/log/contributors_name_updates.log 2>&1
