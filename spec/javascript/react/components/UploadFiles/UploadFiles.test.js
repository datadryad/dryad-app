...
describe('UploadFiles', () => {
  ...
  it('loads and does not show the file note', async () => {
    ...
    expect(screen.queryByLabelText('Describe your file changes for our data curators')).not.toBeInTheDocument();
  });
  ...
  it('shows and changes the file note when files are edited', async () => {
    ...
    const notebox = screen.getByLabelText('Describe your file changes for our data curators');
