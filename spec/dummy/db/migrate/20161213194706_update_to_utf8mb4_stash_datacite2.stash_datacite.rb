# This migration comes from stash_datacite (originally 20160916211100)
class UpdateToUtf8mb4StashDatacite2 < ActiveRecord::Migration
  ...
  TABLES = { 'dcs_affiliations' => %w{ short_name long_name abbreviation },
             ...
             'dcs_sizes' => %w{ size },
             'dcs_subjects' => %w{ subject subject_scheme scheme_URI }
             }
