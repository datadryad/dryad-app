module Mocks
  module Tenant
    ...
    def mock_tenant!(covers_dpc: false)
      ...
      allow(tenant).to receive(:max_files).and_return(1000)
      allow(tenant).to receive(:max_submission_size).and_return(3.0e+11)
      allow(tenant).to receive(:max_total_version_size).and_return(1.0e+10)
