    ...
    RSpec.describe Files do
      ...
      before(:each) do
        ...
        @file_uploads.each do |f|
          @info_hash[f.upload_file_name] = { success: true,
                                                   sha256_digest: Faker::Number.hexadecimal(digits: 64),
                                                   md5_digest: Faker::Number.hexadecimal(digits: 32)}
        end
        ...
        @file_return = []
        @info_hash.each_pair{ |k, v| @file_return.push(file_hash(checksum: v[:md5_digest], filename: k)) }
        json_files = {
            files: @file_return,
      ...
      describe '#upload_files' do
        ...
        it 'uploads a file' do
          ...
          stub_request(:put, "https://sandbox.zenodo.org/api/files/2d80c74b-6a9e-4f58-a462-a44bac79b52a/" \
