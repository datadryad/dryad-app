    ...
    describe DublinCoreBuilder do
      ...
      describe '#build_xml_string' do
        it 'includes related identifiers' do
          rel_ids = RelatedIdentifier::RelationTypesLimited.values.map do |rel_type|
          ...
          dc_builder = DublinCoreBuilder.new(resource: resource, tenant: tenant)
          xml_string = dc_builder.build_xml_string
