  ...
  describe FileValidationService do
    ...
    describe '#validate_file' do
      ...
      it 'sends error mail when checksum mismatch' do
        ...
        allow(StashEngine::NotificationsMailer).to receive_message_chain(:file_validation_error, :deliver_now)
        service.validate_file

        expect(StashEngine::NotificationsMailer).to have_received(:file_validation_error).with(file)
      end
