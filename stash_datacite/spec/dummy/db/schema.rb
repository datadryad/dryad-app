...
ActiveRecord::Schema.define(version: 20_170_223_175_726) do
  ...
  create_table 'dcs_affiliations', force: :cascade do |t|
    t.text     'short_name',   limit: 65_535
    t.text     'long_name',    limit: 65_535
    t.text     'abbreviation', limit: 65_535
    t.datetime 'created_at',                 null: false
    t.datetime 'updated_at',                 null: false
  end
  ...
  create_table 'dcs_alternate_identifiers', force: :cascade do |t|
    t.text     'alternate_identifier',      limit: 65_535
    t.text     'alternate_identifier_type', limit: 65_535
  ...
  create_table 'dcs_creators', force: :cascade do |t|
    t.text     'creator_first_name', limit: 65_535
    t.text     'creator_last_name',  limit: 65_535
    t.integer  'name_identifier_id', limit: 4
    t.integer  'resource_id',        limit: 4
    t.datetime 'created_at',                       null: false
    t.datetime 'updated_at',                       null: false
  ...
  create_table 'dcs_geo_location_places', force: :cascade do |t|
    t.text     'geo_location_place', limit: 65_535
    t.datetime 'created_at',                       null: false
    t.datetime 'updated_at',                       null: false
  end
  ...
  create_table 'dcs_name_identifiers', force: :cascade do |t|
    t.text     'name_identifier',        limit: 65_535
    t.text     'name_identifier_scheme', limit: 65_535
  ...
  create_table 'dcs_related_identifiers', force: :cascade do |t|
    t.text     'related_identifier',      limit: 65_535
    t.string   'related_identifier_type', limit: 7
    t.string   'relation_type',           limit: 19
    t.text     'related_metadata_scheme', limit: 65_535
    t.text     'scheme_URI',              limit: 65_535
    t.text     'scheme_type',             limit: 65_535
    t.integer  'resource_id',             limit: 4
    t.datetime 'created_at',                            null: false
    t.datetime 'updated_at',                            null: false
  end
  ...
  create_table 'dcs_resource_types', force: :cascade do |t|
    ...
    t.text     'resource_type',         limit: 65_535
    t.integer  'resource_id',           limit: 4
    t.datetime 'created_at',                          null: false
    t.datetime 'updated_at',                          null: false
  end
  ...
  create_table 'dcs_subjects', force: :cascade do |t|
    t.text     'subject',        limit: 65_535
    t.text     'subject_scheme', limit: 65_535
    t.text     'scheme_URI',     limit: 65_535
    t.datetime 'created_at',                   null: false
    t.datetime 'updated_at',                   null: false
  end
  ...
  create_table 'searches', force: :cascade do |t|
    t.text     'query_params', limit: 65_535
  ...
  create_table 'stash_engine_file_uploads', force: :cascade do |t|
    t.text     'upload_file_name',    limit: 65_535
    t.text     'upload_content_type', limit: 65_535
    t.integer  'upload_file_size',    limit: 4
    t.integer  'resource_id',         limit: 4
    t.datetime 'upload_updated_at'
    t.datetime 'created_at',                        null: false
    t.datetime 'updated_at',                        null: false
    t.text     'temp_file_path',      limit: 65_535
  ...
  create_table 'stash_engine_identifiers', force: :cascade do |t|
    t.text     'identifier',      limit: 65_535
    t.text     'identifier_type', limit: 65_535
    t.datetime 'created_at',                    null: false
    t.datetime 'updated_at',                    null: false
  end
  ...
  create_table 'stash_engine_resources', force: :cascade do |t|
    ...
    t.text     'download_uri',              limit: 65_535
    t.integer  'identifier_id',             limit: 4
    t.text     'update_uri',                limit: 65_535
  end
  ...
  create_table 'stash_engine_submission_logs', force: :cascade do |t|
    t.integer  'resource_id',                limit: 4
    t.text     'archive_response',           limit: 65_535
    t.datetime 'created_at',                               null: false
    t.datetime 'updated_at',                               null: false
    t.text     'archive_submission_request', limit: 65_535
  end
  ...
  create_table 'stash_engine_users', force: :cascade do |t|
    t.text     'first_name',  limit: 65_535
    t.text     'last_name',   limit: 65_535
    t.text     'email',       limit: 65_535
    t.text     'uid',         limit: 65_535
    t.text     'provider',    limit: 65_535
    t.text     'oauth_token', limit: 65_535
    t.datetime 'created_at',                                null: false
    t.datetime 'updated_at',                                null: false
    t.text     'tenant_id', limit: 65_535
  ...
  create_table 'stash_engine_versions', force: :cascade do |t|
    ...
    t.text     'zip_filename', limit: 65_535
    t.integer  'resource_id',  limit: 4
    t.datetime 'created_at',                 null: false
    t.datetime 'updated_at',                 null: false
  end
