...
ActiveRecord::Schema.define(version: 20190513191822) do
  ...
  create_table "noid_states", force: :cascade do |t|
  ...
  create_table "stash_datacite_temporal_coverages", force: :cascade do |t|
    t.text     "description", limit: 65535
    t.integer  "resource_id", limit: 4
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
  ...
  create_table "stash_engine_authors", force: :cascade do |t|
    ...
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
    t.text     "stripe_customer_id", limit: 65535
  end
  ...
  create_table "stash_engine_counter_stats", force: :cascade do |t|
    t.integer  "identifier_id",              limit: 4
    t.integer  "citation_count",             limit: 4
    t.integer  "unique_investigation_count", limit: 4
    t.integer  "unique_request_count",       limit: 4
    t.datetime "created_at",                           null: false
    t.datetime "updated_at",                           null: false
  end

  create_table "stash_engine_curation_activities", force: :cascade do |t|
    t.string   "status",      limit: 191,   default: "in_progress"
    t.integer  "user_id",     limit: 4
  ...
  add_index "stash_engine_curation_activities", ["resource_id", "id"], name: "index_stash_engine_curation_activities_on_resource_id_and_id", using: :btree
  ...
  create_table "stash_engine_identifiers", force: :cascade do |t|
    ...
    t.datetime "created_at",                                       null: false
    t.datetime "updated_at",                                       null: false
    t.integer  "latest_resource_id", limit: 4
    t.string   "license_id",         limit: 191,   default: "cc0"
    t.text     "search_words",       limit: 65535
    t.text     "invoice_id",         limit: 65535
  end
  ...
  add_index "stash_engine_identifiers", ["latest_resource_id"], name: "index_stash_engine_identifiers_on_latest_resource_id", using: :btree
  add_index "stash_engine_identifiers", ["license_id"], name: "index_stash_engine_identifiers_on_license_id", using: :btree
  add_index "stash_engine_identifiers", ["search_words"], name: "admin_search_index", type: :fulltext

  create_table "stash_engine_internal_data", force: :cascade do |t|
    t.integer  "identifier_id", limit: 4
  ...
  add_index "stash_engine_internal_data", ["data_type", "value"], name: "index_stash_engine_internal_data_on_data_type_and_value", using: :btree
  ...
  create_table "stash_engine_organizations", force: :cascade do |t|
    t.string   "identifier", limit: 191
    t.string   "name",       limit: 191
    t.string   "country",    limit: 191
    t.text     "aliases",    limit: 65535
    t.text     "acronyms",   limit: 65535
    t.boolean  "candidate",                default: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "stash_engine_organizations", ["identifier"], name: "index_stash_engine_organizations_on_identifier", using: :btree
  add_index "stash_engine_organizations", ["name"], name: "index_stash_engine_organizations_on_name", using: :btree

  create_table "stash_engine_repo_queue_states", force: :cascade do |t|
    t.integer  "resource_id", limit: 4
    t.string   "state",       limit: 22
    t.string   "hostname",    limit: 191
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
  end

  add_index "stash_engine_repo_queue_states", ["resource_id"], name: "index_stash_engine_repo_queue_states_on_resource_id", using: :btree
  ...
  create_table "stash_engine_resources", force: :cascade do |t|
    ...
    t.boolean  "skip_datacite_update",                       default: false
    t.boolean  "skip_emails",                                default: false
    t.boolean  "loosen_validation",                          default: false
    t.boolean  "solr_indexed",                               default: false
    t.integer  "current_curation_activity_id", limit: 4
    t.boolean  "preserve_curation_status",                   default: false
  end
  ...
  add_index "stash_engine_resources", ["tenant_id"], name: "index_stash_engine_resources_on_tenant_id", using: :btree
  add_index "stash_engine_resources", ["user_id"], name: "index_stash_engine_resources_on_user_id", using: :btree
  ...
  create_table "stash_engine_users", force: :cascade do |t|
    ...
    t.string   "orcid",            limit: 191
    t.string   "migration_token",  limit: 191
    t.string   "old_dryad_email",  limit: 191
    t.integer  "eperson_id",       limit: 4
    t.integer  "validation_tries", limit: 4,     default: 0
    t.integer  "affiliation_id",   limit: 4
  end

  add_index "stash_engine_users", ["affiliation_id"], name: "index_stash_engine_users_on_affiliation_id", using: :btree
