...
module Stash
  module ZenodoReplicate
    class Deposit
      ...
      def update_metadata(software_file: false, doi: nil, manual_metadata: nil)
        if manual_metadata.nil?
          mg = Stash::ZenodoReplicate::MetadataGenerator.new(resource: @resource, software_file: software_file)
