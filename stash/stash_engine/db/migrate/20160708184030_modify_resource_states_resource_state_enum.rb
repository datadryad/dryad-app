class ModifyResourceStatesResourceStateEnum < ActiveRecord::Migration[4.2]
  def up
    change_table :stash_engine_resource_states do |t|
      t.change :resource_state,
               "ENUM('in_progress', 'processing', 'published', 'error', 'embargoed', 'submitted', 'revised', 'deleted' ) DEFAULT 'in_progress'"
